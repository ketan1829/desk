...
unless Rails.env.production?
  ...
  web_widget = Channel::WebWidget.create!(account: account, website_url: 'https://aspen2-web.dep.lifeel.in')
  ...
  CannedResponse.create!(account: account, short_code: 'start', content: 'Hello welcome to PROFITIZE.')
end
